...
## Project Structure
    ...
    ├── testapiautoconnect_103229  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_103229`
...
2. Clone this repo and `cd testapiautoconnect_103229`
